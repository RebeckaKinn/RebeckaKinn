...
<p>
  My repos include: 
  <ul>
    <li>Code used for live lessons and teachings, and assignment for students.</li>
    <li>Assignments for study, following strict requirements.</li>
    <li>Work assignments, such as making a frontend web application for customers.</li>
    <li>Frontend web application for a start up company.</li>
    <li>Applications and websites made for fun to test new skills.</li>
  </ul>
</p>
...
- **Contact**: becka_1994@hotmail.com

- **Get to know me**: [https://www.linkedin.com/in/rebecka-sandbrekkene-kinn/](https://www.linkedin.com/in/rebecka-sandbrekkene-kinn/)
